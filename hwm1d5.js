...
*/
delete me.skills[skills.length-1]
console.log(me)
...
const whoIsBigger = function(n1,n2){
    if (n1>n2){
        ...
        return "Are the numbers the same?"
    }
}
...
console.log(splitMe("December 1963 what a lady, what a night!"))
...
console.log(deleteOne("THIS IS THe STRING", false))
...
console.log(onlyLetters("This is 56 string we 233 use today 899"))
...
console.log(isThisAnEmail("juanjose1@live.it"))
...
// let previous = new Date(2020,01,01);
...
//     let myBday = new Date(1998, 01, 01);    
//     if (Date === myBday) {
//         return true
//     } else {
//         return false
//     }
// }
// console.log(isTodayMyBDay(new Date(2020,0,0)))
...
// movies.forEach(deleteProp);
// function deleteProp(movies) {
//   delete movies.Title 
// }
...
*/
// const getMovieById = function(string){
//     movies.find(string)
//     return movies
// }
 const getMovieById = function(imdbID) {
    return movies.imdbID === "tt4154796";
  }
